# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-06-11 22:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zdjecie', models.FileField(blank=True, null=True, upload_to=b'')),
                ('certyfikaty', models.ManyToManyField(blank=True, to='produkt.Certyfikat')),
                ('kolor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='produkt.Kolor')),
                ('producent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='produkt.Producent')),
            ],
        ),
        migrations.CreateModel(
            name='Rodzaj_Odziezy',
