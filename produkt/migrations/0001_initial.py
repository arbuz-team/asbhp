# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-06-11 11:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certyfikaty', models.ManyToManyField(to='produkt.Certyfikat')),
        ...
        migrations.AddField(
            model_name='produkt',
            name='zagrozenia',
            field=models.ManyToManyField(to='produkt.Zagrozenie'),
        ),
        migrations.AddField(
            model_name='produkt',
            name='zawody',
            field=models.ManyToManyField(to='produkt.Zawod'),
        ),
        migrations.AddField(
            model_name='polecane',
            name='produkt',
